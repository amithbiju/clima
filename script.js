const options = {
  method: "GET",
  headers: {
    "X-RapidAPI-Key": "13ecd07c70msh271f01b42c8be71p18a2e3jsn31b8087bf7d4",
...
const getWeather2 = () => {
  ...
  fetch(
    "https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=Thiruvananthapuram",
    options
  )
    .then((response) => response.json())
    .then((response) => {
...
const getWeather3 = () => {
  ...
  fetch(
    "https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=kollam",
    options
  )
    .then((response) => response.json())
    .then((response) => {
...
const getWeather5 = () => {
  ...
  fetch(
    "https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=Kozhikode",
    options
  )
    .then((response) => response.json())
    .then((response) => {
